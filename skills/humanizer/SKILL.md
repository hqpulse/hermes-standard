...
name: humanizer
description: |
  Humanizer: rewrite AI-sounding text so it reads like the writer without changing what it says.
...
<!-- humanizer, MIT. Copyright (c) 2025 Siqi Chen. Upstream: github.com/blader/humanizer. Full text in LICENSE. -->
